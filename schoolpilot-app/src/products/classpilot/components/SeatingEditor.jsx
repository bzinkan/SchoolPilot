...
export default function SeatingEditor({ access, initialChart, Shell, ChartForm }) {
  ...
  const confirmAction = () => {
    ...
    if (action.kind === 'layout') { changeLayout(() => createLayout(preset, draft.roster.length)); setSelectedSeat(null); return; }
