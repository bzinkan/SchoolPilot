...
export const createStudentSchema = z.object({
  ...
  classpilotPin: z.string().regex(/^\d{3}$/, "ClassPilot PIN must be 3 digits").optional().or(z.literal("")),
...
export const updateStudentSchema = z.object({
  ...
  classpilotPin: z.string().regex(/^\d{3}$/, "ClassPilot PIN must be 3 digits").optional().nullable().or(z.literal("")),
