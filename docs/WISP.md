...
| My Desk private notebooks (included with ClassPilot; global operational control) | Each eligible staff author has a private workspace, automatically including future entitled schools. Notes, normalized photos and uploaded PDFs remain until deletion or agreed school-account destruction; abandoned saves/staged files expire after 24 hours | Durable object-deletion retries continue when access is disabled; verify database and S3 cleanup independently. See MYDESK_PRIVATE_NOTEBOOK.md and MYDESK_PRODUCTION_RELEASE.md; rollout/operating evidence is required before claiming this control is live |
| My Desk private seating charts (included; separate global operational control) | Author-owned class/roster snapshots and desk layouts remain until deletion or agreed school-account destruction; administrators cannot read another author's charts | Deletion scrubs chart content and retains an operational request tombstone; include rows and backups in verified permanent destruction. See MYDESK_PRIVATE_SEATING.md; no production-control claim before rollout evidence |
| My Desk AI paperwork imports (separate global operational control; teacher-started) | Uploads expire after 24 hours; review expires seven days after upload completion. Completion/cancellation/expiry scrubs drafts and queues source/temporary objects for deletion; approved notes/crops follow normal notebook retention | Durable cleanup retains minimal retry/quota/promotion records and continues when availability or membership is revoked. Local deletion does not establish provider deletion; review actual account retention before activation. See MYDESK_AI_IMPORT.md; implementation tests are not operating or extraction-accuracy evidence |
| My Desk personal filing preferences and student history | School/author-scoped grade defaults remain until changed or verified account destruction; student history uses the author's existing notes and historical filing IDs | Defaults do not move notes. Current directory data requires current roster access; historical notes do not grant new student access. See MYDESK_PRIVATE_NOTEBOOK.md |
| Explicitly submitted school discipline records | School-owned snapshots, independently copied selected evidence, correction/withdrawal history and submitted staff labels remain under the executed agreement and verified school destruction process, including after source deletion or staff departure | No automatic expiry or erasure on withdrawal is claimed. Own submissions plus explicitly granted active admin/school_admin readers; staff lifecycle revokes grants permanently. Abandoned preparation expires after 24 hours with durable object cleanup. Include copies, versions, grants, tombstones and backups in agreed destruction. See SCHOOL_DISCIPLINE_RECORDS.md; tests do not establish a live operating control |
