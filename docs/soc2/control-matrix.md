...
| SP-SEC-004 | CC8.1 | Code changes require CI checks and approved deployment evidence. | Engineering | Per change | Protected branch, CI checks, shadow deployment evidence, digest-pinned artifact when deployed, production approval. | Sample changes and trace commit to PR, CI, artifact hashes, deployment decision, and approval status. | CI evidence, shadow deployment evidence, deploy approval packet | Implementing |
