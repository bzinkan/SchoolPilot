...
# ordinary minimum returns to one at 16:00, and target tracking may scale up
# to six. The live emergency revision remains selected independently because
# ECS task definitions are deliberately ignored by this staged Terraform
# profile.
enable_api_arrival_capacity     = true
api_arrival_min_capacity        = 3
api_max_capacity                = 6
...
# Observed 109-table production baseline, verified 2026-09-26T11:29:50.6337614Z.
# Preserve the exact runtime CSV from the private post-admission-live.json receipt
# after My Desk reconciliation on API147/worker162. The registry's historical
# inventories, original migration checksums and generic 75-table default remain
# unchanged. This baseline adoption itself does not run Terraform apply.
rls_enabled_tables = "activity_log,audit_logs,block_lists,bus_routes,chat_messages,classpilot_active_hands,classpilot_ai_decisions,classpilot_classroom_states,classpilot_command_targets,classpilot_commands,classpilot_coverage_assignments,classpilot_coverage_scope_group_members,classpilot_coverage_scope_groups,classpilot_scheduled_conflicts,classpilot_session_students,classpilot_session_usage,classpilot_supervision_contexts,classpilot_supervision_students,classroom_course_students,classroom_courses,daily_usage,dashboard_tabs,devices,dismissal_sessions,email_alerts,email_scan_log,error_logs,evidence_artifacts,family_groups,flight_paths,google_roster_connectors,grades,groups,heartbeats,homerooms,import_runs,mailpilot_watches,messages,parent_student,passes,security_events,settings,student_attendance,student_groups,student_safety_cases,student_timeline_events,students,subgroups,teacher_students,teaching_sessions,walker_zones,classpilot_session_summary_deliveries,passpilot_grade_students,authorized_pickups,custody_alerts,dismissal_changes,dismissal_overrides,dismissal_queue,family_group_students,homeroom_teachers,classpilot_monitoring_events,classpilot_session_reports,classpilot_session_staff,classpilot_session_student_reports,classpilot_student_control_states,classpilot_schedule_change_pairs,classpilot_schedule_changes,classpilot_schedule_change_legs,classpilot_chat_deliveries,poll_responses,polls,session_settings,passpilot_kiosk_sessions,passpilot_kiosk_devices,classpilot_evidence_capture_requests,student_safety_alerts,student_safety_case_events,safety_url_exceptions,safety_notification_outbox,classpilot_school_schedules,roster_integration_connections,roster_integration_runs,roster_integration_identities,roster_integration_memberships,classpilot_school_website_policies,classpilot_school_website_deliveries,classpilot_monitoring_expectations,classpilot_monitoring_interruptions,classpilot_monitoring_interruption_settings,classpilot_monitoring_interruption_digests,classpilot_coverage_group_categories,classpilot_supervision_report_segments,classpilot_supervision_student_reports,classpilot_supervision_summary_deliveries,classpilot_timers,classpilot_lesson_activities,classpilot_lesson_progress,classpilot_questions,classpilot_picker_rounds,classpilot_tool_templates,classpilot_routine_runs,classpilot_tool_history,passpilot_teacher_kiosk_settings,mydesk_attachments,mydesk_notes,mydesk_seating_charts,mydesk_import_assets,mydesk_import_items,mydesk_imports"
