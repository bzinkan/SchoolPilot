...
describe("ClassPilot web-session routing", () => {
  ...
  it("keeps device- and student-token traffic off the web-session pool", () => {
    for (const req of [
      ...
      request("POST", "/api/classpilot/extension/device-continuity/preflight"),
      request("POST", "/api/classpilot/extension/device-continuity"),
      request("POST", "/api/extension/device-continuity/preflight"),
      request("POST", "/api/extension/device-continuity"),
