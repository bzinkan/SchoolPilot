...
export type HeartbeatHotPathCounter =
  ...
  | "screenshotUploadTrackingWindowClosed"
  | "screenshotCapturedAtBeforeAuthority"
  | "screenshotCapturedAtAfterAuthority"
  | "screenshotCapturedAtOutsideTrackingWindow"
  | "screenshotCapturedAtExpired"
  | "screenshotCapturedAtFuture"
  | "screenshotAuthorityStartFromStudentSession"
  | "screenshotAuthorityStartFromTeachingStart"
  | "screenshotAuthorityStartFromRosterSnapshot"
  | "screenshotAuthorityStartFromControlUpdated"
