...
export default function ScheduleProfileDraftReview({ review, filters, onFiltersChange, onEditIssue }) {
  ...
  return <section aria-label="Draft schedule review" className="min-w-0 space-y-4">
    ...
    {data && <>
      ...
      {rows.length ? <div role="region" aria-label="Proposed day timetable" tabIndex={0} className="max-h-[55dvh] overflow-auto rounded-lg border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
