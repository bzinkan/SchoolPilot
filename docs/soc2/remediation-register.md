...
| SOC2-002 | P0 | AI/privacy | AI claims and implementation require completed private review; default-off teacher-started paperwork imports add uploaded page-image processing. | Engineering | Before observation and before import activation | Data-flow and actual provider-account retention/deletion review, updated public docs, non-content audit events, authorization/cleanup tests, separate synthetic extraction-quality and correction-effort review | In progress |
| SOC2-003 | P0 | Privileged access | In-app privileged MFA and token revocation are deferred; privileged access review and MFA deferral risk acceptance are being evidenced in the meantime. | Engineering | Before observation | Privileged access evidence packet, private user/role export, access review approval, MFA deferral risk acceptance, MFA export when implemented | In progress |
