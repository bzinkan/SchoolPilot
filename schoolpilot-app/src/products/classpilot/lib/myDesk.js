...
export function myDeskApi(schoolId, signal) {
  ...
  return {
    ...
    seatingChart: id => request('GET', `/seating-charts/${encodeURIComponent(id)}`),
    ...
    duplicateSeatingChart: (id, data) => request('POST', `/seating-charts/${encodeURIComponent(id)}/duplicate`, data),
    currentSeatingChart: (id, data) => request('PUT', `/seating-charts/${encodeURIComponent(id)}/current`, data),
