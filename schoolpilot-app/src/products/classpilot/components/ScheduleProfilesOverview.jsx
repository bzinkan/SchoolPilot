...
export default function ScheduleProfilesOverview({ data, busy, blocked, refreshing, statusUnavailable, serverNow, latestServerNow, testingStatuses, statusReasons, onOpen, onDelete, onCancel, onCancelBlock, onDeleteHistory, onRefresh, applicationsHeadingRef }) {
  ...
  return <div className="space-y-8">
    ...
    <section aria-label="Schedule profile applications" className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">Testing status is separate from class changes. To finish active testing early, use End testing on the dashboard, Release in Supervision, or Cancel block here. Change end time is for manually started sessions.</p>
