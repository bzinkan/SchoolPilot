...
5. **Save profile** opens the exact saved schedule automatically. Saving does not apply anything. Use **Edit profile** to continue, or **Close schedule** and reopen it later with **Open profile**. A failed schedule review after a successful save can be retried without saving again.
