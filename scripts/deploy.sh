...
validate_rls_table_enablement_mode() {
  ...
  case "$ENABLE_RLS_TABLE" in
    classpilot_session_summary_deliveries|passpilot_grade_students|passpilot_kiosk_sessions|classpilot_monitoring_events,classpilot_session_reports,classpilot_session_staff,classpilot_session_student_reports,classpilot_student_control_states|classpilot_chat_deliveries,poll_responses,polls,session_settings|authorized_pickups,custody_alerts,dismissal_changes,dismissal_overrides,dismissal_queue,family_group_students,homeroom_teachers|classpilot_schedule_change_pairs,classpilot_schedule_changes,classpilot_schedule_change_legs) ;;
    *)
