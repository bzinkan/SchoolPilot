...
2. Release the extension separately from the ClassPilot repository. The follow-up release preparation bumped the extension to 2.9.2 and created `C:/GitHub/ClassPilot/dist/ClassPilot-v2.9.2.zip` from local release commit `676c715b39007bbddd640f743c652cfd9d32eeeb` (tag `v2.9.2`). No upload has occurred. The public Store listing was checked directly on September 22, 2026 and showed 2.9.1; confirm it again immediately before upload. Retain the package SHA-256 and validation record in that directory.
