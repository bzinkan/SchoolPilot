...
import { MAX_SEATS } from '../lib/seatingModel';
...
export function SeatingChartForm({ access, mode, source, onClose, onSaved, initialDraft, onLeave }) {
  ...
  const [roomUnit, setRoomUnit] = useState('imperial'), [roomWidth, setRoomWidth] = useState(''), [roomHeight, setRoomHeight] = useState('');
