...
export default defineConfig({
  schema: [
    ...
    "./src/schema/safetyCenter.ts",
    "./src/schema/classpilotScheduling.ts",
    "./src/schema/rosterIntegrations.ts",
    "./src/schema/classpilotSchoolWebsitePolicy.ts",
    "./src/schema/classpilotMonitoringInterruptions.ts",
  ],
  out: "./migrations",
  dialect: "postgresql",
  dbCredentials: {
